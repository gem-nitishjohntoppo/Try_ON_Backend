...
def upload_necklace():
    ...
    logging.debug(f"Uploaded necklace image with ID: {necklace_id}")
    return jsonify({"necklace_id": necklace_id})
...
def upload_ring():
    ...
    logging.debug(f"Uploaded ring image with ID: {ring_id}")
    return jsonify({"ring_id": ring_id})
...
def upload_earring():
    ...
    logging.debug(f"Uploaded earring image with ID: {earring_id}")
    return jsonify({"earring_id": earring_id})
...
def upload_bracelet():
    ...
    logging.debug(f"Uploaded bracelet image with ID: {bracelet_id}")
    return jsonify({"bracelet_id": bracelet_id})
